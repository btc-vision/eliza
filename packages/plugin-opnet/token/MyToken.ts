...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u256.fromString('10000000000000000000000000'); // Your max supply.
        const decimals: u8 = 18; // Your decimals.
        const name: string = 'bob the noob 16'; // Your token name.
        ...
        this._mint(
            Address.fromString('021033e8eb8b23540dd770ef3e79d08e509f4daf5dd3ae17cfdc1fb27c246b8ccc'),
            maxSupply,
        );
    }
